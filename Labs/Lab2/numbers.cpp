...
void gameboard::TroOne(int T1X, int T1Y, int T1HS){
      board[T1X+T1HS-1][T1Y+T1HS]=1;     //2
      board[T1X+T1HS][T1Y+T1HS] = 1;           //4
      board[T1X+T1HS][T1Y+T1HS-1]=1;      //3
}

void gameboard::TroTwo(int T1X, int T1Y, int T1HS){
      board[T1X+T1HS-1][T1Y+T1HS-1]=2;   //1
      board[T1X+T1HS][T1Y+T1HS-1]=2;	          //3
      board[T1X+T1HS][T1Y+T1HS] = 2;       //4
}

void gameboard::TroThree(int T1X, int T1Y, int T1HS){
      board[T1X+T1HS-1][T1Y+T1HS]=3;      	  //2
      board[T1X+T1HS-1][T1Y+T1HS-1]=3;    //1
      board[T1X+T1HS][T1Y+T1HS] = 3;        //4
}

void gameboard::TroFour(int T1X, int T1Y, int T1HS){
      board[T1X+T1HS-1][T1Y+T1HS-1]=4;         //1
      board[T1X+T1HS-1][T1Y+T1HS]=4;       //2
      board[T1X+T1HS][T1Y+T1HS-1]=4;        //3
}
